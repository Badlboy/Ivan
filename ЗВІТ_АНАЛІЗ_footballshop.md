...
Орієнтовні оцінки для магазину ~40–50 м² у цінах 2026 року. Усі суми — прогнозні
й потребують уточнення під конкретну локацію та орендні ставки.
...
> покривала OpEx, виручка має бути ~0,8–1,1 млн грн/міс (~9,8–13,5 млн грн/рік).
> Це спрощена модель — реальна точка беззбитковості залежить від структури націнки
> за категоріями, знижок і сезонності.
...
- *Позикове фінансування:* позика ~2 400 000 грн під ~12% річних на 5 років —
  ...
  ~0,8 млн грн). У перші місяці операційний прибуток від'ємний — обов'язковий
