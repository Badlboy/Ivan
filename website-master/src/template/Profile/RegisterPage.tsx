...
const RegisterPage = ({
    ...
    async function onSubmit(values: typeof initialValues) {
        ...
        try {
            ...
            toast.success(translations[locale].pages.register.isVerifyLoad, {
                id: toast_id,
            })
            setSend(true)
        } catch (error: any) {
        ...
        <section className="section-auth-register">
            <figure>
                <Image
                    ...
                    alt={translations[locale].pages.register.info4}
                    width={0}
                    sizes="50vw"
                    height={0}
                />
                            ...
                            {!send && status == 0 ? (
                                <>
                                    <span className="form-title">
                                        {
                                            translations[locale].pages.register
                                                .info4
                                        }
                                    </span>
                                    <div className="social">
                                        <span>
                                            {
                                                translations[locale].page.basket
                                                    .register
                                            }
                                            :
                                        </span>
